...
Welcome to the UWCS x Chess Soc x Optiver Chess Engine Competition 2026!

This project will allow you to make your own custom chess engine by implementing your own evaluation function. All participants are required to use the base chess engine implementation found in this repo. This ensures that all competitors code will run and reduce the range of concepts you need to worry about.
